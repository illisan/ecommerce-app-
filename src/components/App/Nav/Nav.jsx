                ...
                <div className="navbar-fixed">
                    <nav>
                        <div className="nav-wrapper  grey  grey darken-4">
                            <a href="/" className="brand-logo center"><img src="/imgs/logo.png" className="navLogo" /></a>
                            ...
                            <a className="right"><Link to="/shop/cart"><i className="material-icons">shopping_cart</i></Link></a>
                        </div>
                    </nav>
                </div>
            </div>
