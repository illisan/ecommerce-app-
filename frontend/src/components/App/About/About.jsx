        ...
        return (
            <div >
                ...
                <div className="container">
                    <div className="aboutCopy center-align row">

                        <p className="opening col m12 s12">Etnica believes in sustainable, timeless, natural wear.We believe in a link between
                    style and storytelling, that the best stories, like the best garments withstand the test
                    of time.</p>
                        <img alt="" className="responsive-img col m12 s12 " src=" /imgs/about.jpg" />
                        ...
                        <img alt="" className="responsive-img col m12" src=" /imgs/about2.jpg" />
                        <div className="col m12">
                            <h3>Our Mission</h3>
